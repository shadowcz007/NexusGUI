...
### 6.1 启动模式优化
- [x] 提供首次启动向导，让用户选择默认启动模式
- [x] 在系统托盘菜单中增加"切换到主窗口模式"选项
- [x] 默认以系统托盘模式启动，减少资源占用

### 6.2 窗口管理简化
- [x] 提供自动窗口管理选项，根据应用使用场景智能决定是否复用窗口
- [x] 增加"一键关闭所有动态窗口"功能到托盘菜单
- [x] 在窗口标题栏增加"固定窗口"选项，防止被自动关闭

### 6.3 HTML 到 Markdown 转换优化
- [x] 在 render-gui 工具执行后，自动显示 Markdown 文件路径
- [x] 提供"在文件管理器中显示"选项，方便用户访问生成的文件
- [x] 增加转换结果预览功能，用户可以直接查看转换后的 Markdown

### 6.4 系统托盘增强
- [x] 增加最近渲染的界面历史记录，支持快速重新渲染
- [x] 提供"快速测试"功能，渲染预定义的测试界面
- [x] 增加网络状态指示，显示与 AI 工具的连接状态

### 6.5 调试功能增强
- [x] 提供统一的调试控制台，集中显示所有日志和调试信息
- [x] 增加实时监控面板，显示服务器状态、会话数量、资源使用等
- [x] 提供 API 测试工具，方便开发者测试 MCP 工具调用
