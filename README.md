...
```javascript
// 使用 show-in-file-manager 工具在文件管理器中显示 Markdown 文件
{
  "filePath": "/tmp/nexusgui-cache/界面标题-2025-08-03T14-51-39-788Z.md"
}

// 返回结果：
// ✅ 已在文件管理器中显示文件:
// 📁 /tmp/nexusgui-cache/界面标题-2025-08-03T14-51-39-788Z.md
```
...
// 返回完整的 Markdown 文本内容（如果内容较长，会显示前1000个字符的预览）
```
